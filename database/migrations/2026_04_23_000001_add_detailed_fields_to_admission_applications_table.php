...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('admission_applications', function (Blueprint $table) {
            ...
            $table->string('language_of_communication')->nullable()->after('church_denomination');
            ...
            $table->string('father_name')->nullable()->after('primary_contact_name');
            $table->string('mother_name')->nullable()->after('father_name');
            $table->string('father_residential_address')->nullable()->after('mother_name');
            $table->string('mother_residential_address')->nullable()->after('father_residential_address');
            ...
            $table->string('father_office_address')->nullable()->after('mother_occupation');
            $table->string('mother_office_address')->nullable()->after('father_office_address');
