...
@section('dashboard')
<div class="space-y-4">
    <h1 class="text-2xl font-semibold">Create Student</h1>
    <form method="POST" action="{{ route('students.store') }}" class="space-y-4 bg-white p-6 rounded shadow max-w-xl">
        @csrf
        <div>
        ...
        <div>
            ...
            @else
                ...
                @if($branches->count() > 0)
                    ...
                    <p class="text-sm text-gray-600 mt-1">You can only assign students to your branch.</p>
                @else
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('students.index') }}" class="px-4 py-2 border rounded hover:bg-gray-50">Cancel</a>
        </div>
    </form>
</div>
@endsection
