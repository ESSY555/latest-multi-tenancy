    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300">
                ...
                <form method="POST" action="{{ route('admin.profile.photo.update') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    <div class="relative">
        ...
        <div class="bg-white rounded-2xl shadow-xl mt-8 p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            ...
            <form method="POST" action="{{ route('admin.profile.emergency-contact.update') }}" class="space-y-6">
                @csrf
        ...
        <div class="bg-white rounded-2xl shadow-xl mt-8 p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            ...
            <form method="POST" action="{{ route('admin.profile.notifications') }}" class="space-y-6">
                @csrf
                <div class="space-y-6">
...
<form id="delete-photo-form" method="POST" action="{{ route('admin.profile.photo.delete') }}" style="display: none;">
    @csrf
    @method('DELETE')
</form>
