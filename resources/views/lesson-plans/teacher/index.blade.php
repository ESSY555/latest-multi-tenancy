...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Create, manage, and track your lesson plans</p>
        </div>
        ...
        <div class="mb-6 border-b border-gray-200">
            <nav class="-mb-px flex space-x-8">
                <a href="{{ route('lesson-plans.index') }}" class="py-2 px-1 border-b-2 font-medium text-sm transition-colors cursor-pointer {{ request()->routeIs('lesson-plans.index') && !request('status') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    All
                </a>
                <a href="{{ route('lesson-plans.by-status', 'draft') }}" class="py-2 px-1 border-b-2 font-medium text-sm transition-colors cursor-pointer {{ request()->is('*/draft') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Drafts
                </a>
                <a href="{{ route('lesson-plans.by-status', 'submitted') }}" class="py-2 px-1 border-b-2 font-medium text-sm transition-colors cursor-pointer {{ request()->is('*/submitted') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Submitted
                </a>
                <a href="{{ route('lesson-plans.by-status', 'approved') }}" class="py-2 px-1 border-b-2 font-medium text-sm transition-colors cursor-pointer {{ request()->is('*/approved') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Approved
                </a>
                <a href="{{ route('lesson-plans.by-status', 'rejected') }}" class="py-2 px-1 border-b-2 font-medium text-sm transition-colors cursor-pointer {{ request()->is('*/rejected') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Rejected
                </a>
            </nav>
        </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by creating your first lesson plan.</p>
                    <div class="mt-6">
                        <a href="{{ route('lesson-plans.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition-colors cursor-pointer">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
