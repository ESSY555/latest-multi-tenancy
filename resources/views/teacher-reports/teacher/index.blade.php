...
<div class="space-y-4">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Manage and track your daily teaching reports</p>
        </div>
        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6">
                ...
                <a href="{{ route('teacher-reports.by-status', 'draft') }}" 
                   class="py-4 px-1 border-b-2 font-medium text-sm {{ request('status') === 'draft' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Draft
                </a>
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Get started by creating your first teacher report.</p>
                <div class="mt-6">
                    <a href="{{ route('teacher-reports.create') }}" 
