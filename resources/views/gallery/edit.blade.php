...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Update gallery item: {{ $gallery->title }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data" id="gallery-form">
                @csrf
                @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="text-sm text-gray-600">
                                <p><strong>Current:</strong> {{ $gallery->image_path }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="category" 
                                ...
                                <option value="{{ $category }}" @if(old('category', $gallery->category) == $category) selected @endif>
                                    {{ ucfirst($category) }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="branch_id" 
                                ...
                                <option value="{{ $branch->id }}" @if(old('branch_id', $gallery->branch_id) == $branch->id) selected @endif>
                                    {{ $branch->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center h-5">
                                <input id="is_active" 
                                       ...
                                       type="checkbox" 
                                       value="1"
                                       @if(old('is_active', $gallery->is_active)) checked @endif
