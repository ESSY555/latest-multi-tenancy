...
class SuperAdminProfileController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            if (session('current_role') !== 'super_admin') {
                abort(403, 'Unauthorized access to super admin profile management.');
            }
            return $next($request);
        });
    }
    ...
    public function index()
    {
        ...
        return view('dashboard.super-admin.profile', compact('user'));
    }
